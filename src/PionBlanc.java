...
public class PionBlanc extends Pion{
    ...
    public ArrayList<Position> getDeplacementPossibleEchec(Plateau p) 
    {
        ...
        if ((p.getCase(i,j+1)==null )&&j<9)
        {
            tab.add(new Position(i,j+1));
        }
        if ((p.getCase(i,j+2)==null && p.getCase(i,j+1)==null)&&j+2<9&&j==2)
        {
    ...
    public ArrayList<Position> getDeplacementPossible(Plateau p) 
    {
        ...
        if ((p.getCase(i+1,j+1)!=null && p.getCase(i+1,j+1).getCouleur()!=getCouleur())&&j+1<9&&i+1<9)
        {
            tab.add(new Position(i+1,j+1));
        }
